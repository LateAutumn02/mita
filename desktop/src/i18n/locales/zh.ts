...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.memory.title': '全局记忆',
  'settings.memory.description': '查看和编辑 Claude 写入的 Markdown 记忆文件。这些文件全局存放在 ~/.claude/memory/，会被 CLI 运行时跨项目加载。',
  'settings.memory.refresh': '刷新',
  'settings.memory.projects': '记忆目录',
  ...
  'settings.memory.emptyProjects': '还没有找到记忆目录。',
  'settings.memory.emptyFiles': '还没有找到记忆文件。',
  'settings.memory.selectFile': '选择一个记忆文件。',
  'settings.memory.selectProject': '选择记忆目录。',
  ...
  'settings.memory.projectSearchPlaceholder': '按路径搜索...',
  'settings.memory.fileSearchPlaceholder': '搜索记忆文件...',
  'settings.memory.resourceSearchPlaceholder': '搜索记忆文件...',
  'settings.memory.noProjectMatches': '没有匹配的记忆目录。',
  ...
  'slashCmd.memory.description': '在设置中打开记忆文件',
