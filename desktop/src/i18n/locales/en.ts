export const en = {
  ...
  'settings.activity.defaultHandle': 'github.com/LateAutumn02/mita',
  ...
  'settings.memory.title': 'Global Memory',
  'settings.memory.description': 'Inspect and edit the Markdown memory files Claude writes. These files are stored globally under ~/.claude/memory/ and are loaded by the CLI runtime across all projects.',
  'settings.memory.refresh': 'Refresh',
  'settings.memory.projects': 'Directory',
  ...
  'settings.memory.emptyProjects': 'No memory directory found.',
  'settings.memory.emptyFiles': 'No memory files found yet.',
  'settings.memory.selectFile': 'Select a memory file.',
  'settings.memory.selectProject': 'Select the memory directory.',
  ...
  'settings.memory.projectSearchPlaceholder': 'Search by path...',
  'settings.memory.fileSearchPlaceholder': 'Search memory files...',
  'settings.memory.resourceSearchPlaceholder': 'Search memory files...',
  'settings.memory.noProjectMatches': 'No memory directory matches this search.',
  ...
  'slashCmd.memory.description': 'Open memory files in Settings',
